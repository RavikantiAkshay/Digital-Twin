...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#080d1a] text-slate-100 font-sans relative overflow-hidden">
      ...
      {mode === 'visualizer' && (
        <div className="h-screen w-screen flex flex-col overflow-hidden">
          ...
          <div className="flex-1 relative overflow-hidden">
            {isLoading ? (
              <div className="h-full w-full flex flex-col items-center justify-center bg-[#080d1a] text-blue-400 gap-4">
